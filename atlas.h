...
const byte font_atlas[][7] = {
    ...
    { 0x00, 0x24, 0x2A, 0x6B, 0x2A, 0x12, 0x00 }, // $
    ...
    { 0x00, 0x42, 0x42, 0x7E, 0x00, 0x00, 0x00 }, // ]
    ...
    { 0x00, 0x0C, 0x52, 0x52, 0x52, 0x3E, 0x00 }, // g (with true descender)
    ...
    { 0x00, 0x0C, 0x50, 0x50, 0x50, 0x3C, 0x00 }, // y (with true descender)
